...
export const AVATAR_PRESETS: AvatarPreset[] = [
  { id: "ceo",         bg: "#1a365d", label: "CEO / President",       icon: CeoIcon },
  { id: "cto",         bg: "#2b6cb0", label: "CTO / Technical Director", icon: CtoIcon },
  { id: "cfo",         bg: "#2f855a", label: "CFO / Finance Director", icon: CfoIcon },
  { id: "cmo",         bg: "#dd6b20", label: "CMO / Marketing Director", icon: CmoIcon },
  { id: "cpo",         bg: "#6b46c1", label: "CPO / Product Director", icon: CpoIcon },
  { id: "architect",   bg: "#2c5282", label: "Architect",             icon: ArchitectIcon },
  { id: "dev-m",       bg: "#3182ce", label: "Developer (Male)",      icon: DevMIcon },
  { id: "dev-f",       bg: "#00838f", label: "Developer (Female)",    icon: DevFIcon },
  { id: "devops",      bg: "#4a5568", label: "DevOps Engineer",       icon: DevopsIcon },
  { id: "designer-m",  bg: "#d53f8c", label: "Designer (Male)",       icon: DesignerMIcon },
  { id: "designer-f",  bg: "#b83280", label: "Designer (Female)",     icon: DesignerFIcon },
  { id: "pm",          bg: "#805ad5", label: "Product / Project Manager", icon: PmIcon },
  { id: "analyst",     bg: "#3182ce", label: "Data Analyst",          icon: AnalystIcon },
  { id: "marketer",    bg: "#e53e3e", label: "Marketing",             icon: MarketerIcon },
  { id: "writer",      bg: "#744210", label: "Copywriter / Writer",   icon: WriterIcon },
  { id: "hr",          bg: "#c05621", label: "Human Resources",       icon: HrIcon },
  { id: "legal",       bg: "#718096", label: "Legal Counsel",         icon: LegalIcon },
  { id: "support",     bg: "#319795", label: "Customer Support",      icon: SupportIcon },
  { id: "researcher",  bg: "#276749", label: "Researcher",            icon: ResearcherIcon },
  { id: "media",       bg: "#e53e3e", label: "Social Media",          icon: MediaIcon },
];
