...
try:
    ...
    raise ImportError(
        "mss is required for screenshot functionality. "
...
class ScreenCapture:
    ...
    def __init__(self):
        ...
        self._last_screenshot_info: Optional[ScreenshotInfo] = None
        ...
        if use_cache and self._last_screenshot is not None:
            ...
            if cache_age < config.cache_ttl:
                ...
                if self._last_screenshot_info:
                    if (monitor == self._last_screenshot_info.monitor and
                        region == self._last_screenshot_info.region):
