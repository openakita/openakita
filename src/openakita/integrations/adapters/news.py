...
class JuheNewsAdapter(BaseAPIAdapter):
    ...
    async def get_channel_news(self, channel: str = 'top', page: int = 1, page_size: int = 10) -> dict:
        """获取指定频道新闻"""
        return await self.call("/toutiao/index", params={'channel': channel, 'page': page, 'page_size': page_size})
