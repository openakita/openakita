...
MODEL_CAPABILITIES = {
    ...
    "anthropic": {
        # Anthropic 官方
        "claude-opus-4.5": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-sonnet-4.5": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-haiku-4.5": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-3-opus": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-3-sonnet": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-3-haiku": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-3-5-sonnet": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "claude-3-5-haiku": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
    },
    ...
    "dashscope": {
        ...
        "qwen2.5-vl": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        ...
        # 视觉模型
        "qwen-vl-max": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "qwen-vl-max-latest": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "qwen-vl-plus": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "qwen-vl-plus-latest": {"text": True, "vision": True, "video": False, "tools": True, "thinking": False},
        "qwen3-vl-plus": {"text": True, "vision": True, "video": False, "tools": True, "thinking": True},
        "qwen3-vl-flash": {"text": True, "vision": True, "video": False, "tools": True, "thinking": True},
        # QwQ 推理模型
    ...
    "minimax": {
        # MiniMax 官方
        "minimax-m2.1": {"text": True, "vision": False, "video": False, "tools": True, "thinking": False},
        "minimax-m2": {"text": True, "vision": False, "video": False, "tools": True, "thinking": False},
    ...
    "zhipu": {
        ...
        "glm-4.7": {"text": True, "vision": False, "video": False, "tools": True, "thinking": False},
    ...
    "google": {
        ...
        "gemini-3-pro": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
        "gemini-3-flash": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
        "gemini-2.5-pro": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
        "gemini-2.5-flash": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
        "gemini-2.0-flash": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
        "gemini-2.0-flash-lite": {"text": True, "vision": True, "video": False, "tools": False, "thinking": False},
        "gemini-1.5-pro": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
        "gemini-1.5-flash": {"text": True, "vision": True, "video": True, "tools": True, "thinking": False},
    },
...
def infer_capabilities(
    ...
    # Tools 推断 (大部分主流模型都支持)
    if any(kw in model_lower for kw in ["qwen", "gpt", "claude", "deepseek", "kimi", "glm", "gemini", "moonshot"]):
        caps["tools"] = True
    
    return caps


def get_provider_slug_from_base_url(base_url: str) -> Optional[str]:
    """
    从 base_url 推断服务商标识
...
def supports_capability(model_name: str, capability: str, provider_slug: Optional[str] = None) -> bool:
    """检查模型是否支持某种能力"""
    caps = infer_capabilities(model_name, provider_slug)
    return caps.get(capability, False)


def is_thinking_only(model_name: str, provider_slug: Optional[str] = None) -> bool:
    """检查模型是否仅支持思考模式"""
    caps = infer_capabilities(model_name, provider_slug)
