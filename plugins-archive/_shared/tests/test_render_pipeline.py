"""Tests for _shared.render_pipeline."""
...
from _shared import RenderPipeline, build_render_pipeline
from _shared.render_pipeline import RenderSegment
...
def fake_ffmpeg(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("_shared.render_pipeline.shutil.which", _which)
    return fake
