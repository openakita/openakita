...
| _this commit_ | P-RC-5 P5.5 | refactor(runtime/state_graph/guards): extract verb-to-tool fragment maps | +85 (_verb_tool_map.py + 5 tests) / -52 (2 legacy dicts replaced by re-imports); core/reasoning_engine 8536 -> 8484 | +5 (anchor entries + shape + parity-via-identity) | ADR-0001, ADR-0002 |
