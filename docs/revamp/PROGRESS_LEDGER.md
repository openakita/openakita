...
| _this commit_ | P-RC-5 P5.8b | test(runtime/state_graph/guards): 22 cases for tool-filter guards | +144 (test_tool_filters.py) | +22 (anchor + 11 behaviour + 8 shell-write parametrize + 2 legacy-identity parity) | ADR-0001 |
