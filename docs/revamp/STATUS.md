...
| P-RC-8 — Endgame (audit nits + docs + ADR flip + acceptance + release tag) | **In progress (P8.0..P8.4 landed)** | 4 so far (P8.0 nits + P8.2 ADR flip + P8.3 ACCEPTANCE + P8.4 P-RC-9 charter) | 1123 / 1123 + 1 skipped + 5 xfailed (+1 brain smoke vs P-RC-7) |
