...
个人和企业的专属云端数字助手，文件UploadDownload、备份、分享、Manage一句话搞定。
...
bdpan login — Use OAuth 流程在浏览器中授权。令牌存储在 ~/.config/bdpan/config.json。
...
- 不要在公开频道分享认证码
- 共享环境Use后Execute bdpan logout

## Pre-built Scripts

### scripts/bdpan.py
百度网盘 Open API 封装，需Set BAIDU_NETDISK_TOKEN。
